...
if [ ! -f $input_file ]
   then 
   echo "###########################################################"
   echo "#    FASE 1 - INSERIRE NOME DEL FILE DA LEGGERE           #"
   echo "###########################################################"
  #############################################################
	...
	echo ".end" >> $input_file
  echo "###########################################################"
  echo "#    FILE DI INPUT CREATO: $input_file               #"
  echo "###########################################################"
  echo "###########################################################"
  echo "#    FASE 2 - SCELTA NUMERO DEI COLORI                    #"
  echo "###########################################################"
else
  echo "###########################################################"
  echo "#    FASE 2 - SALTO FASE LETTURA - SCELTA NUMERO COLORI   #"
  echo "#  FASE DECODICA DEL FILE:  $input_file             #"
  echo "###########################################################"
...
echo "###########################################################"
echo "#    CALCOLO CLIQUE PIÙ GRANDE PER NUMERO MINIMO COLORI   #"
echo "###########################################################"
...
while [ $finish -le $zero ]; do
    ...
    echo "###########################################################"
    echo "#    FILE $cnf PER MINISAT GENERATO CON $NColori COLORI   #"
    echo "#           VERIFICA COLORABILITA' CON MINISAT            #"
    echo "###########################################################"
    #timeout 15 
    ./Minisat $cnf $control
      ##################################################################
      ...
      if [ -s $control ]; then
        ...
        echo "###########################################################"
        echo "#    FINITO - FORMULA SODDISFACIBILE CON: $NColori COLORI  #"
        echo "###########################################################"
            echo ""
            finish=2
        fi
...
echo "###########################################################"
echo "#    TEMPO TOTALE DI ESECUZIONE  IN SECONDI: $DIFF  #"
echo "###########################################################"
